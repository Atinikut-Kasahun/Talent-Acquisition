...
export default function UserMetaCard() {
  ...
  const [profileData, setProfileData] = useState({
    ...
    linkedin: "https://www.linkedin.com/company/droga-group",
    instagram: "https://instagram.com/DrogaGroup",
  });
            ...
            <div className="custom-scrollbar h-[450px] overflow-y-auto px-2 pb-3">
              <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                <div className="col-span-2 lg:col-span-1">
                  ...
                  <Input type="text" value={tempData.name} onChange={(e) => handleChange("name", e.target.value)} />
                </div>
                <div className="col-span-2 lg:col-span-1">
                  <Label>Role / Bio</Label>
                  <Input type="text" value={tempData.role} onChange={(e) => handleChange("role", e.target.value)} />
                </div>
                <div className="col-span-2">
                  <Label>Location</Label>
                  <Input type="text" value={tempData.location} onChange={(e) => handleChange("location", e.target.value)} />
                </div>
                <div className="col-span-2">
                  <h5 className="mb-2 mt-2 text-base font-medium text-gray-700 dark:text-white/80">Social Links</h5>
                </div>
                <div className="col-span-2 lg:col-span-1">
